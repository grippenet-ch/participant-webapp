...
### Quali rischi si assume se decide di partecipare a questo studio?

Prevediamo due tipi di rischio lieve nell'aderire a questo studio:

- Il team di ricerca avrà accesso ai dati del tuo questionario, comprese le informazioni demografiche e mediche di base. Tuttavia, i vostri dati, in forma grezza, sono quasi anonimi, poiché non vi si chiede di fornire il vostro nome e cognome, ma solo uno pseudonimo e un indirizzo e-mail. Inoltre, gli pseudonimi e gli indirizzi e-mail sono conservati separatamente dai dati del questionario. Questo significa che analizziamo solo i dati anonimizzati del questionario, senza utilizzare il tuo pseudonimo e gli indirizzi e-mail. Inoltre, abbiamo progettato la nostra strategia di raccolta dei dati (dettagliata di seguito nella sezione gestione dei dati) in modo che i dati raccolti tramite il tuo smartphone siano completamente anonimizzati (\"privacy by design\"). In particolare, non colleghiamo mai questi dati al tuo pseudonimo e al tuo indirizzo e-mail, a meno che tu non lo richieda esplicitamente.
- Il rischio di un attacco informatico che porta alla perdita dei dati raccolti. Questo rischio è comunque minimizzato dall'infrastruttura in atto e dalla nostra strategia sulla privacy dei dati (di nuovo, dettagliata nella sezione sulla gestione dei dati) che rende difficile collegare i dati sensibili all'identità di un individuo. Inoltre, i dati che raccogliamo sono di natura molto insensibile e gli stessi dati potrebbero essere sottratti direttamente dal suo telefono, indipendentemente dalla sua partecipazione a questo studio.

---

### Diritti dei partecipanti

La decisione di partecipare deve essere presa esclusivamente per libera scelta. Questa decisione non avrà alcun impatto sulle tue cure mediche attuali o future. Puoi scegliere in qualsiasi momento di smettere semplicemente di partecipare. Se utilizzi il sito e desideri che cancelliamo i tuoi dati, contattaci semplicemente utilizzando i dettagli alla fine di questo documento (che puoi trovare anche nella sezione contatti del sito). Nota, tuttavia, che questa cancellazione - a differenza di un'interruzione dello studio - ci richiede di collegare i vostri dati dei questionari al tuo pseudonimo, informazioni che altrimenti vengono tenute separate.

Ti ricordiamo inoltre che la legge protegge il tuo diritto di accesso, aggiornamento, rettifica e opposizione al trattamento dei suoi dati. Tali diritti comprendono, a titolo esemplificativo e non esaustivo, il diritto di ottenere la conferma dell'esistenza o meno di dati che ti riguardano e di esserne informati in forma intelligibile, nonché l'indicazione dell'origine dei dati, delle finalità e modalità del trattamento, l'aggiornamento, la rettifica o l'integrazione dei vostri dati, la cancellazione, la trasformazione in forma anonima o il blocco dei dati personali trattati in violazione di legge e il diritto di opporsi, in tutto o in parte, al loro utilizzo. Nonostante quanto sopra, tranne nei casi in cui la legge permette il trattamento dei dati personali senza il consenso della persona interessata (per esempio, per rispettare gli obblighi stabiliti dalla legge o per eseguire gli ordini delle autorità pubbliche, comprese le autorità giudiziarie), non utilizzeremo i vostri dati personali per scopi diversi da quelli dello studio. Si noti che questo può includere la pubblicazione e la presentazione a conferenze scientifiche, in forma aggregata e completamente anonima.
