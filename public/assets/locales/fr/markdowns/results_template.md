...
Le projet utilise des données issues d’un système de surveillance participatif visant à suivre les infections respiratoires aiguës (ARI) et les maladies de type grippal (ILI) en Suisse. L’objectif est de mieux comprendre la dynamique de transmission des infections respiratoires et de fournir des informations sur les symptômes qu’elles provoquent.

Ensemble, nous pouvons suivre la situation en Suisse dès les premiers stades. Les participants signalent chaque semaine s’ils ont eu un ou plusieurs symptômes.
...
Le graphique montre le nombre de participants déclarant un symptôme spécifique. Une combinaison de symptômes peut indiquer une maladie infectieuse spécifique, comme la grippe, le Covid-19, le VRS ou d’autres
