...
Il nuovo team di Grippenet dell’Università di Berna ringrazia sinceramente tutti i partecipanti fedeli e spera di continuare a motivarvi a contribuire a questo importante progetto. In Svizzera, la stagione influenzale si verifica generalmente tra dicembre e marzo, con un picco tra gennaio e febbraio ([Bulletin OFSP 43/24](https://www.bag.admin.ch/dam/de/sd-web/etouYVJUie1A/bu-43-24.pdf)). Monitorando i vostri sintomi, ci aiutate a comprendere meglio le dinamiche delle malattie infettive come l'influenza e il COVID-19 in Svizzera, permettendo interventi più mirati ed efficaci.
